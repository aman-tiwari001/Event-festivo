        ...
        <form onSubmit={handleSignUp}>
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full p-2 border border-gray-300 rounded-md  sm:text-sm input-primary"
            />
          ...
          <label htmlFor="address" className="text-white mt-2">
            Residential Address
          </label>
          <input
            type="text"
          ...
          <button
            type="submit"
            className="w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 my-4"
          >
            Sign Up
          </button>
